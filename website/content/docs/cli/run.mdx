...
| `--watch` | Keep the engine alive and start new tasks automatically as they become available; watching runs report idle rather than completion when no work is available |
